package ir.avvalmarket.miladesign;
...
import ir.avvalmarket.miladesign.utilfiles.Purchase;
import ir.avvalmarket.miladesign.utilfiles.IabHelper;
import ir.avvalmarket.miladesign.utilfiles.IabResult;
import ir.avvalmarket.miladesign.utilfiles.Inventory;
import ir.avvalmarket.miladesign.utilfiles.SkuDetails;

/**
 * Avval MArket Plug-in
 *
 * @author		Milad Mohammadi
 * @copyright		MilaDesign Inc. 2016
 * @file		IAP.java
...
public class IAP extends CordovaPlugin {
	...
	private static final String LOG_TAG = "AvvalMarketPlugin";
